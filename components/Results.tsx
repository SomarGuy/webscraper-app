            ...
            >
                ...
                <div className="flex flex-col py-5 flex-1">
                    ...
                    <div className="flex space-x-2 justify-end flex-1">
                        <p className="font-bold text-emerald-800 pt-2 text-xl mt-auto">
                            {result.price > 0 ? `${result.price}` : "N/A"}
                        </p>

                        {result.previous_price > 0 && (
                            <p className="font-bold text-emerald-800/50 line-through pt-2 text-xl mt-auto">
                    ...
                    <div className="flex flex-wrap gap-2 justify-end mt-5">
                        {result.features.map((feature) => (
                            feature && (
                                <p
                                key={feature}
                                className="text-xs bg-emerald-800 px-2 py-1 text-white rounded-md" 
                                >
                                {feature} 
                                </p>
                            )
